...
$$U_A = \frac{3 + 4 + 11 + 6 + 1 + 4 + 1 + 1 + 2 + 1}{1000} = \frac{34}{1000} = 0{,}034 = \mathbf{3{,}4}\text{ por ciento}$$
...
![wcet_max[] inicial sin SIM ni antena GSM](docs/img/wcet_init_1.png)
...
$$U_B = \frac{3 + 4 + 29 + 21 + 2 + 4 + 1 + 1 + 2 + 1}{1000} = \frac{68}{1000} = 0{,}068 = \mathbf{6{,}8}\text{ por ciento}$$
